...
public class SharePointList extends SharePointBase {

	private String query = null;
	private String queryOptions = null;
	private static Properties properties = new Properties();
	private static final Log logger = LogFactory.getLog(SharePointList.class);
	...
	public static void main(String[] args) {
		logger.debug("main...");
		SharePointList example = new SharePointList();
		try {
			example.initialize();
