    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.microsoft.sharepoint.webservices.Copy.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.microsoft.sharepoint.webservices.Copy.class.getResource(".");
